...
<!-- Container -->
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-lg-4 mb-3">
          <div class="card">
            <img src="{{ asset('assets/img/muamalat.jpg')}}" class="card-img-top" alt="..." width="300" height="200">
            <div class="card-body">
              ...
              <a href="https://bit.ly/VIX_BI_Analyst_DashboardGDS" target = "_blank" class="btn btn-primary">View Project</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-3">
          <div class="card">
            <img src="{{ asset('assets/img/btpns.jpeg')}}" class="card-img-top" alt="..." width="300" height="200">
            <div class="card-body">
              ...
              <a href="https://drive.google.com/file/d/1GpErDnsneymd0iXqsbwl4rPN_001aq-o/view?usp=share_link" target = "_blank" class="btn btn-primary">View Project</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-3">
          <div class="card">
          <img src="{{ asset('assets/img/rakamin.png')}}" class="card-img-top" alt="..." width="300" height="200">
            <div class="card-body">
              ...
              <a href="https://drive.google.com/file/d/1lRqXK3JUBHfOWOr-pPO2FpwXCabV_2e1/view?usp=share_link" target = "_blank" class="btn btn-primary">View Project</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-lg-4 mb-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="https://drive.google.com/file/d/1NrG4Fj5y2dGsxaYke4qcSQ7Sa8Auoi4A/view?usp=share_link" target="_blank" class="btn btn-primary">View Project</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-3">
          <div class="card">
            <img src="{{ asset('assets/img/bwa.jpg') }}" class="card-img-top" alt="..." width="100" height="250">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-3">
          <div class="card">
            <img src="{{ asset('assets/img/games.png') }}" class="card-img-top" alt="..." width="100" height="250">
            <div class="card-body">
              ...
              <a href="https://colab.research.google.com/drive/1-Y_UdIMWWxcd0hNb9gA__r5zEMLsCqam?usp=share_link" target="_blank" class="btn btn-primary">View Project</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-4 mb-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="https://drive.google.com/file/d/1Pftzg8sHtNAd_N-D-iM2YD-BFWd-jY8U/view?usp=share_link" target="_blank" class="btn btn-primary">View Project</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-3">
