    ...
    <div class="row">
      ...
      <ul>
        ...
        <li>
          ...
          <p>Certified Data Analyst RMDS</p>
          <p>2023</p>
        </li>
      </ul>
      <!-- Education -->
      ...
      <div class="col-md-8">
        ...
        <ul>  
          <!-- DWBI -->
          <li>
            <strong>Datawarehouse and Business Intelligence</strong>
            <p>Develop a Sales Dashboard utilizing Google Data Studio within the realm of Data Warehouse and Business Intelligence.</p>
            <a href="https://bit.ly/FinalProject_DWBI" class="link-dark" target="_blank">Link Project</a>
          </li>
          <!-- Linear Regression -->
          <li>
            <strong>Linear Regression</strong>
            <p>Utilize linear regression to forecast the price of pizza.</p>
            <a href="https://colab.research.google.com/drive/1zWbO2xOpqM9n9_ECqR8IhJik3wVXf--G?usp=share_link" class="link-dark" target="_blank">Link Project</a>
          </li>
          <!-- CDA -->
          <li>
            ...
            <a href="https://colab.research.google.com/drive/1bD3s4Ul64bOYhOzjO9NxHwJHtrkn9_7b?usp=share_link" class="link-dark" target="_blank">Link Project</a>
          </li>
        </ul>
      </div>
    </div>
